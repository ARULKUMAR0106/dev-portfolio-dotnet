        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="portfolio-card border-purple-500  border-l border-r border-t border-b border-dashed border-slate-400 dark:border-slate-400">
                <div className="text-3xl font-bold text-primary mb-1">3+</div>
                <div className="text-sm text-muted-foreground">Years Experience</div>
              </div>
              <div className="portfolio-card border-red-500  border-l border-r border-t border-b border-dashed border-slate-400 dark:border-slate-400">
                <div className="text-3xl font-bold text-primary mb-1">2+</div>
                <div className="text-sm text-muted-foreground">Enterprise level Projects Completed</div>
              </div>
                            <div className="portfolio-card border-cyan-500  border-l border-r border-t border-b border-dashed border-slate-400 dark:border-slate-400">
